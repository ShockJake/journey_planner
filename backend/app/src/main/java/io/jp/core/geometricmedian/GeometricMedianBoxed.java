...
public class GeometricMedianBoxed {
    private static final double TOLERANCE = 1e-10;
    private static final int MAX_ITERATIONS = 50;

    public static PointBoxed calculateGeometricMedian(List<PointBoxed> points) {
    ...
    private static PointBoxed centroid(List<PointBoxed> points) {
        PointBoxed result = points.stream().reduce(new PointBoxed(0d, 0d),
    ...
    private static double[] calculateNextPoint(List<PointBoxed> points, PointBoxed result) {
