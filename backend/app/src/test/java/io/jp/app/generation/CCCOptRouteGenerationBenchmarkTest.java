...
@TestPropertySource(properties = """
        ...
        """)
public class CCCOptRouteGenerationBenchmarkTest extends GenerationTestBase {
    @Autowired
    private MockMvc mockMvc;
    @Autowired
    private RouteDataInit routeDataInit;
    private boolean shouldDoWarmUp = true;
    private static final String OUTPUT_PATH = "route_generation_no-opt_" + Instant.now().getEpochSecond() + ".csv";
    ...
    @Test
    void shouldGenerationRoute() throws Exception {
        // when
