...
@TestPropertySource(properties = """
        ...
        """)
public class CBOptRouteOptimizationBenchmarkTest extends OptimizationTestBase {
    @Autowired
    private MockMvc mockMvc;
    @Autowired
    private RouteDataInit routeDataInit;
    private boolean shouldDoWarmUp = true;
    private static final String OUTPUT_PATH = "route_optimization_opt_" + Instant.now().getEpochSecond() + ".csv";
