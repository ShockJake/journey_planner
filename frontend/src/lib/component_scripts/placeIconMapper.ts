import { Church, Castle, GraduationCap, Landmark, Pizza, Coffee, Drama, GitCommitVertical, Store, Sparkles, House, Amphora, CircleHelp, Shrub, Ship, Binoculars, TrainFront } from "$lib/components/common/Icons.ts";
