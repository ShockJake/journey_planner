<script lang="ts">
	...
	const { body, dialog, height, width } = $props();
	...
	<Transition show={$dialog.expanded}>
		...
		<div class="fixed inset-0 overflow-y-auto">
			<div class="flex min-h-full items-center justify-center p-4 text-center">
				...
				>
					<div
						class="{height} {width} transform overflow-hidden rounded-2xl bg-white p-3 text-left align-middle shadow-xl transition-all"
						use:dialog.modal
					>
